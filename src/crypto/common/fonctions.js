...
function affiche_sousmenu(num)
{
  // On remet tout à zéro
   for (i=1;i<5;i++) document.getElementById("sousmenu_" + i).style.display = "none";
   
 // On affiche ce qui nous intéresse...  
   
   document.getElementById("sousmenu_" + num).style.display = "flex";
   console.log(document.getElementById("sousmenu_" + num));
...
function showAll(idinner,idimage)
{
      ...
      {
          inner.style.display = "";
          image.setAttribute("src","http://www.bibmath.net/ressources/lib/bas.png");
      }
      else
      {
          inner.style.display = "none";
          image.setAttribute("src","http://www.bibmath.net/ressources/lib/droite.png");          
      }
}